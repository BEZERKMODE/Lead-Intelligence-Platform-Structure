...
from backend.database import Base, engine, has_pgvector

# Detect if using SQLite fallback or if pgvector is unavailable
is_sqlite = engine.url.drivername == "sqlite"
use_pgvector = (not is_sqlite) and has_pgvector
